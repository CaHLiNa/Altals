...
test('buildDocumentRunArtifactCards compacts compile diagnosis artifacts for sidebar display', () => {
  ...
  assert.deepEqual(
    cards[0].meta.map((entry) => entry.label),
    ...
    [
      {
        ...
        changes: [
          {
            filePath: '/Users/math173sr/Desktop/paper/conference/main.tex',
            summary: 'Replaced text A -> B',
          },
          {
            filePath: '/Users/math173sr/Desktop/paper/conference/main.tex',
            summary: 'Replaced text C -> D',
          },
          {
            filePath: '/Users/math173sr/Desktop/paper/conference/main.tex',
            summary: 'Replaced text E -> F',
          },
          {
            filePath: '/Users/math173sr/Desktop/paper/conference/main.tex',
            summary: 'Replaced text G -> H',
          },
        ],
        body: 'Patch body',
      },
