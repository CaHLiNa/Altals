...
#[cfg(test)]
mod tests {
    use super::{validate_ai_base_url, validate_ai_request_url, validate_url};
    ...
    #[test]
    fn ai_stream_proxy_accepts_full_https_request_url() {
        let parsed = validate_ai_request_url("https://api.openai.com/v1/chat/completions").unwrap();
        assert_eq!(parsed.host_str(), Some("api.openai.com"));
    }
}
