...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            fs_commands::workspace_create_document_file,
            fs_commands::workspace_document_template_content,
            ...
            latex_runtime::latex_runtime_source_resolve,
            latex_runtime::latex_runtime_change_resolve,
