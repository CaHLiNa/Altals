...
- `ReferenceView`、`NotebookCell`、`FileTree`、`AddReferenceDialog` 这类 editor/sidebar 历史组件仍有较多原生表单控件和局部按钮视觉，需要后续切片继续收敛
...
- 继续迁移 PDF deeper controls、Notebook cell 周边和更多 editor-heavy surface 的历史按钮/输入/toolbar 写法
